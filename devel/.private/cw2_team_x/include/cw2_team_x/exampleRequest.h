// Generated by gencpp from file cw2_team_x/exampleRequest.msg
// DO NOT EDIT!


#ifndef CW2_TEAM_X_MESSAGE_EXAMPLEREQUEST_H
#define CW2_TEAM_X_MESSAGE_EXAMPLEREQUEST_H
...
struct exampleRequest_
{
  ...
  typedef boost::shared_ptr< ::cw2_team_x::exampleRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::cw2_team_x::exampleRequest_<ContainerAllocator> const> ConstPtr;

}; // struct exampleRequest_

typedef ::cw2_team_x::exampleRequest_<std::allocator<void> > exampleRequest;

typedef boost::shared_ptr< ::cw2_team_x::exampleRequest > exampleRequestPtr;
typedef boost::shared_ptr< ::cw2_team_x::exampleRequest const> exampleRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::cw2_team_x::exampleRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::cw2_team_x::exampleRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::cw2_team_x::exampleRequest_<ContainerAllocator1> & lhs, const ::cw2_team_x::exampleRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::cw2_team_x::exampleRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::cw2_team_x::exampleRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::cw2_team_x::exampleRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::cw2_team_x::exampleRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x16f08f6abcc9049eULL;
  static const uint64_t static_value2 = 0x818ebd0c826029fcULL;
};

template<class ContainerAllocator>
struct DataType< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::cw2_team_x::exampleRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cw2_team_x::exampleRequest_<ContainerAllocator>& v)
  {
...
#endif // CW2_TEAM_X_MESSAGE_EXAMPLEREQUEST_H
